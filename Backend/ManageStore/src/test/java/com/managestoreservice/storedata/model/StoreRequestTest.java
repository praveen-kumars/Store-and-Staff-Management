...
StoreRequest storesDto=new StoreRequest();
	...
	@Test
	void StoreDtoTest() {
		StoreRequest storeDto=new StoreRequest("76bc9","REQ-76bc9","G14-11 th street","Los Angles, California, 12343","8220551256","9am-7pm","9am-7pm","9am-7pm","9am-7pm","9am-7pm","","",null);
		storeDto.setStore_Id("8bc74");
		storeDto.setRequest_Id("REQ-8bc74");
		...
		storeDto.setStore(null);
		assertEquals("8bc74",storeDto.getStore_Id());
		assertEquals("REQ-8bc74",storeDto.getRequest_Id());
		...
		assertEquals(null,storeDto.getStore());
